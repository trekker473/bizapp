...
//Add row to Hours Lines Array
      ...
      div.innerHTML = cols;
      document.getElementById('dayTable1').appendChild(div);
}
/*
    newRow.append(cols);
    document.getElementById('dayTable' + counter)append(newRow);
    hrsDay1.push(counter);
    counter1++;
 }
                        ...
                        <div class="dayContainer">\
                          <table id="dayTable' + dayCounter + '" class="dayTable">\
                            ...
                            <tbody>\
                              <tr>\
                                <td class="leftField">\
                                  <input class="dayDate" id="date' + dayCounter + '" type="text"/>\
                                </td>\
                                ...
                                <td class="noteTd"><img src="img/Empty-Note-icon-sm.png" name="note' + dayCounter + '-1"  id="note' + dayCounter + '-1" class="note"/></td>\
                              </tr>\
                              <tr>\
                                <td class="leftField">\
                                  <input class="dayDate" id="date' + dayCounter + '" type="text"/>\
                                </td>\
                                <td class="projectSelectT"><select name="project' + dayCounter + '-2" id="project' + dayCounter + '-2" class="projectSelect" />\
                                  <option value="TLS" selected>TLS</option>\
                                  <option value="Other">Other</option>\
                                </select>\
                                </td>\
                                <td class="payTypeSelectT"><select name="pay-type' + dayCounter + '-2" id="pay-type' + dayCounter + '-2" class="payTypeSelect" />\
                                  <option value="Standard" selected>Standard</option>\
                                  <option value="Vacation">Vacation</option>\
                                  <option value="Sick">Sick</option>\
                                  <option value="Holiday">Holiday</option>\
                                ...
                                <td class="col-sm-4"><input type="time" name="timein' + dayCounter + '-2" id="timein' + dayCounter + '-2" class="timeField" oninput="checkThenCalc(\'0\', \'timein1\',\'timeout1\', \'hrs1-0\')"/></td>\
                                <td class="col-sm-4"><input type="time" name="timeout' + dayCounter + '-2" id="timeout' + dayCounter + '-2" class="timeField" oninput="checkThenCalc(\'0\', \'timein1\',\'timeout1\', \'hrs1-0\')"/></td>\
                                <td class="timeDivs hrs"><div class="hrs" name="hrs' + dayCounter + '-2" id="hrs' + dayCounter + '-2">0.00</div></td>\
                                <td class="timeDivs"><div class="calcHrs" name="reg' + dayCounter + '-2" id="reg' + dayCounter + '-2">0.00</div></td>\
                                <td class="timeDivs"><div class="calcHrs" name="ot' + dayCounter + '-2" id="ot' + dayCounter + '-2">0.00</div></td>\
                                <td class="timeDivs"><div class="calcHrs" name="dt' + dayCounter + '-2" id="dt' + dayCounter + '-2">0.00</div></td>\
                                <td class="timeDivs"><div class="calcHrs" name="pto' + dayCounter + '-2" id="pto' + dayCounter + '-2">0.00</div></td>\
                                <td class="noteTd"><img src="img/Empty-Note-icon-sm.png" name="note' + dayCounter + '-2"  id="note' + dayCounter + '-2" class="note"/></td>\
                              </tr>\
                            </tbody>\
                            <tfoot>\
                              <tr>\
                                ...
                                <td colspan="3">\
                                <button name="addrows" id="addrows" onclick="('+ dayCounter +', -1)">Add Additional Time-in / Time-out</button>\
                                </td>\
